  ...
  return (
    <div className="min-h-screen bg-(--bg-base) flex items-center justify-center p-8">
      ...
      >
        ...
        <div className="mb-8">
          <h2 className="font-display text-2xl font-bold text-(--text-primary) mb-1">Create your account</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <Input label="Username" placeholder="jashan"
            ...
            hint="Your public URL: creatorforge.io/@jashan"
            required />
            ...
            <div key={field} className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2.5 pr-10 text-sm bg-(--bg-elevated) text-(--text-primary) border rounded-md placeholder:text-(--text-muted) focus:outline-none focus:border-(--accent) focus:ring-2 focus:ring-(--accent)/20 transition-all border-(--border)"
                  required
                />
                {field === "password" && (
                  <button type="button"
